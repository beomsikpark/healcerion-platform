...
> **상태**: 미시작
> **⚑ 범위 축소(2026-08-02)**: **샘플은 `C++`/Qt6 1벌만** 낸다(6-B). C#·JNI·ObjC++ 정본화(6-A)와 Python 코어 샘플(6-C)·Flutter 추출(6-D)은 **연기**한다 — 근거 = [../goal.md §1 ⚑](../goal.md). **지원 매트릭스(6-E)와 지원 경계(6-F)는 축소하지 않는다** — 출시 제품이 그것을 필요로 한다.
