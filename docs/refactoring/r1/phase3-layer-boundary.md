...
> **상태**: 진행 중 — **3-A·3-B·3-F·3-K 완료 · 3-I 부분 완료**(2026-08-03). SDK→ADK 역방향 참조 **15→0** 이고 `adk/` 를 지운 트리에서 SDK 8개 모듈이 빌드된다. 3-C·3-E(실측)·3-G 는 판정 장치·실측 완료(2026-08-02, 커밋 `b8dc55bf`·`ce121c4a`·`b83869f5`). 코드 이동(3-A·3-B·3-D·3-E·3-H·3-I·3-J·3-K)은 미시작
